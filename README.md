...
- Lexically scoped universal and existential quantifier negation, scope, and
  vacuous-quantification rules, with a specification of capture-avoiding
  substitution for their binders.
